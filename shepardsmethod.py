...
Implementation of Shepard's Method for calculation of Inverse Distance Weight
"""

def inverseDistance(data,vec1):
...
inverseDistance(getIrisDataSet(),(5.4,3.4,1.5,0.4))
#getIrisDataSet()
#def findKNN():
#    data=getTestDataSet()
#    for i in range(len(data)):
